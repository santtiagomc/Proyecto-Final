...
export default function FiltersNav({ editorials }) {
  ...
  function handleFilterGenres(e) {
    dispatch(changeFilter({ sort: filtersApplied.sort, editorial: filtersApplied.editorial, genres: e.target.value }))
  }

  function handleFilterEditorial(e) {
    dispatch(changeFilter({ sort: filtersApplied.sort, editorial: e.target.value, genres: filtersApplied.genres }))
  }

  function handleFilterSort(e) {
    dispatch(changeFilter({ sort: e.target.value, editorial: filtersApplied.editorial, genres: filtersApplied.genres }))
  }
    ...
    <>
      <nav>
        ...
        >
          ...
          <option value="A-Z" selected={filtersApplied.sort === "A-Z" ? true : false}>A - Z</option>
          <option value="Z-A" selected={filtersApplied.sort === "Z-A" ? true : false}>Z - A</option>
        ...
        <select
          ...
          <option value="none" selected={filtersApplied.editorial === "none" ? true : false}> Todas las editoriales</option>
          {editorials && editorials.map((el) => <option value={el} selected={filtersApplied.editorial === el ? true : false}>{el}</option>)}
        </select>
