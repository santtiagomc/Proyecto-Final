  ...
  return (
			<>
				<nav className={style.container}>
					...
					<select name="sort" onChange={handleFilterSort} className={style.select}>
					...
					<label className={style.label}>Filtrar por editoriales:</label>
					<select
						name="editorial"
					...
					<button onClick={reset} className={style.button}>Resetear todo</button>
				</nav>
			</>
		);
}
